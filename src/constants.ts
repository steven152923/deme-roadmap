...
export const VIEW_TITLES: Record<ViewId, { eyebrow: string; title: string }> = {
  ...
  calendar: { eyebrow: 'everything with a date, in one place', title: 'Calendar' },
  notes: { eyebrow: 'private scratchpads, plans and fragments', title: 'Notes' },
  decisions: { eyebrow: 'remember why you chose the thing', title: 'Decision log' },
  launch: { eyebrow: 'turn finished work into a safe release', title: 'Launch center' },
